@extends('layout.app')
@section('title', 'Verifikasi akun anda')
                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light px-sm-5 py-5 px-4 text-left">
                            ...
                            <h6 class="fw-light tw-text-slate-500 tw-leading-6">
                                ...
                                <strong class="tw-font-semibold">({{Auth::user()->no_wa}}), </strong>
                                dan Email anda 
                                <strong class="tw-font-semibold">({{Auth::user()->email}}), </strong>
                                <br> 
                                Silahkan periksa dan isi kode OTP dibawah ini.
                            </h6>
                            <form class="pt-3" method="post" action={{route('sales.verify')}}>
                                @csrf
